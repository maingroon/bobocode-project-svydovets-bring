...
/**
 * This annotation is a marker for the Bring that method marked with this annotation returns Bean. The Bring takes care
 * for all lifecycle and injections of the object marked as {@link Bean}.
